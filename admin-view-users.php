        ...
        <div class="col-sm-8">
            ...
            try {
                ...
                $query = "SELECT last_name, first_name, email, 
                                DATE_FORMAT(registration_date, '%M %d, %Y') AS regdat, userid 
                ...
                if ($result) {
                    ...
                    $row = mysqli_fetch_array($result, MYSQLI_ASSOC)
                        ...
                        // Remove special characters that might already be in the table
                        $user_id = htmlspecialchars(
                            $row["userid"],
                            ENT_QUOTES
                        );
                        ...
                        $registration_date = htmlspecialchars(
                            $row["regdat"],
                            ENT_QUOTES
                        );
                        echo "<tr>
'                           <td><a href='edit_user.php?id=$user_id'>Edit</a></td>
                    ...
                    echo "We apologise for any inconvenience.</p>";
                    // Debug message:
                    echo "<p>" .
                        mysqli_error($dbcon) .
                        "<br><br>Query: " .
